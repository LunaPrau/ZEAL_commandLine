classdef PDB < handle
    ...
    % pdbread() functions from Matlabs Bioinformatics Toolbox. The
    ...
    properties
        ...
        FileSource % Whether generated by PYMOL or not
    end
    ...
    methods
        ...
        function obj = PDB(IDorFileName, varargin)
            ...
            %
            % <fileSource>                     :       string       ('')
            %   if 'pymol' then assumes 19 fields as in molecules exported from pymol,
            %   if empty then 21 fields as in original script
            %
            % <selection>                  :       struct
            %
